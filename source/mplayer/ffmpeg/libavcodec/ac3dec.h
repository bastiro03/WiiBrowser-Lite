...
typedef struct
{
	...
	,
	output
	)[AC3_MAX_CHANNELS][AC3_BLOCK_SIZE]; ///< output after imdct transform and windowing
	DECLARE_ALIGNED (
	32
	,
	uint8_t
	,
	input_buffer
	)[AC3_FRAME_BUFFER_SIZE + FF_INPUT_BUFFER_PADDING_SIZE]; ///< temp buffer to prevent overread
	///@}
} AC3DecodeContext;
