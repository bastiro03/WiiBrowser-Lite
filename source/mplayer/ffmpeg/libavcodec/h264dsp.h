...
void ff_h264dsp_init(H264DSPContext* c, int bit_depth,
                     int chroma_format_idc);
void ff_h264dsp_init_arm(H264DSPContext* c, int bit_depth,
                         int chroma_format_idc);
void ff_h264dsp_init_ppc(H264DSPContext* c, int bit_depth,
                         int chroma_format_idc);
void ff_h264dsp_init_x86(H264DSPContext* c, int bit_depth,
                         int chroma_format_idc);
