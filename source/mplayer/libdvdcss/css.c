...
static int AttackPattern(const uint8_t [], int, uint8_t*);
#if 0
...
void _dvdcss_test(dvdcss_t dvdcss)
{
	...
	switch (i_rpc)
	{
	case 0: psz_rpc = "RPC-I";
		break;
	case 1: psz_rpc = "RPC-II";
		break;
	default: psz_rpc = "unknown RPC scheme";
		break;
	}

	switch (i_type)
	{
	case 0: psz_type = "no region code set";
		break;
	case 1: psz_type = "region code set";
		break;
	case 2: psz_type = "one region change remaining";
		break;
	case 3: psz_type = "region code set permanently";
		break;
	default: psz_type = "unknown status";
		break;
	}
