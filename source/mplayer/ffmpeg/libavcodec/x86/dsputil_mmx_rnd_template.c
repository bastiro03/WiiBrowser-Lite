...
static void av_unused DEF(put, pixels8_l2)(uint8_t* dst, uint8_t* src1, uint8_t* src2, int dstStride, int src1Stride,
                                           int h)
{
	MOVQ_BFE(mm6);
	volatile __asm__ (
...
static void av_unused DEF(put, pixels16_l2)(uint8_t* dst, uint8_t* src1, uint8_t* src2, int dstStride, int src1Stride,
                                            int h)
{
	MOVQ_BFE(mm6);
	volatile __asm__ (
...
void DEF(avg, pixels8_l2)(uint8_t* dst, uint8_t* src1, uint8_t* src2, int dstStride, int src1Stride, int h)
{
	MOVQ_BFE(mm6);
	JUMPALIGN();
	do
...
void DEF(avg, pixels16_l2)(uint8_t* dst, uint8_t* src1, uint8_t* src2, int dstStride, int src1Stride, int h)
{
	MOVQ_BFE(mm6);
	JUMPALIGN();
	do
