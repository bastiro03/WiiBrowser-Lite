...
int predictor_update_filter(APEPredictor* p,
...
static const AVOption options[] = {
	{
		"max_samples", "maximum number of samples decoded per call", OFFSET(blocks_per_loop), AV_OPT_TYPE_INT, {4608},
		1, INT_MAX, PAR, "max_samples"
	},
	{
		"all", "no maximum. decode all samples for each packet at once", 0, AV_OPT_TYPE_CONST, {INT_MAX}, INT_MIN,
		INT_MAX, PAR, "max_samples"
	},
	{NULL},
};
