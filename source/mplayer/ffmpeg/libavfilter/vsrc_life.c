...
static const AVOption life_options[] = {
	...
	{
		"random_fill_ratio", "set fill ratio for filling initial grid randomly", OFFSET(random_fill_ratio),
		AV_OPT_TYPE_DOUBLE, {.dbl = 1 / M_PHI}, 0, 1
	},
	{
	...
	{
		"random_seed", "set the seed for filling the initial grid randomly", OFFSET(random_seed), AV_OPT_TYPE_INT,
		{.dbl = -1}, -1, UINT32_MAX
	},
	{
		"seed", "set the seed for filling the initial grid randomly", OFFSET(random_seed), AV_OPT_TYPE_INT, {.dbl = -1},
		-1, UINT32_MAX
	},
	...
	{
		"death_color", "set death color", OFFSET(death_color_str), AV_OPT_TYPE_STRING, {.str = "black"}, CHAR_MIN,
		CHAR_MAX
	},
