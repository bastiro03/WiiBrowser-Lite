...
static GtkAdjustment *A3125adj, *A125adj, *A6250adj, *A250adj, *A500adj, *A1000adj, *A2000adj, *A4000adj, *A8000adj, *
                     A16000adj;
...
static void eqSetChannelNames(void)
{
	...
	{
		str[0] = gtkEquChannel1;
		gtk_clist_append(GTK_CLIST(ChannelsList), str);
		str[0] = gtkEquChannel2;
		gtk_clist_append(GTK_CLIST(ChannelsList), str);
	}
	if (guiInfo.AudioChannels > 2)
	{
		str[0] = gtkEquChannel3;
		gtk_clist_append(GTK_CLIST(ChannelsList), str);
		str[0] = gtkEquChannel4;
		gtk_clist_append(GTK_CLIST(ChannelsList), str);
	}
	if (guiInfo.AudioChannels > 4)
	{
		str[0] = gtkEquChannel5;
		gtk_clist_append(GTK_CLIST(ChannelsList), str);
		str[0] = gtkEquChannel6;
		gtk_clist_append(GTK_CLIST(ChannelsList), str);
	}
...
static gboolean eqHScaleMotion(GtkWidget* widget, GdkEventMotion* event, gpointer user_data)
{
	...
	{
	case 0: eq.gain = A3125adj->value;
		break;
	case 1: eq.gain = A6250adj->value;
		break;
	case 2: eq.gain = A125adj->value;
		break;
	case 3: eq.gain = A250adj->value;
		break;
	case 4: eq.gain = A500adj->value;
		break;
	case 5: eq.gain = A1000adj->value;
		break;
	case 6: eq.gain = A2000adj->value;
		break;
	case 7: eq.gain = A4000adj->value;
		break;
	case 8: eq.gain = A8000adj->value;
		break;
	case 9: eq.gain = A16000adj->value;
		break;
...
static gboolean eqVScaleMotion(GtkWidget* widget, GdkEventMotion* event, gpointer user_data)
{
	switch ((int)user_data)
	{
	case 1: mplayer(MPLAYER_SET_CONTRAST, VContrastadj->value, 0);
		break;
	case 2: mplayer(MPLAYER_SET_BRIGHTNESS, VBrightnessadj->value, 0);
		break;
	case 3: mplayer(MPLAYER_SET_HUE, VHueadj->value, 0);
		break;
	case 4: mplayer(MPLAYER_SET_SATURATION, VSaturationadj->value, 0);
		break;
	}
...
GtkWidget* create_Equalizer(void)
{
	...
	gtk_table_attach(GTK_TABLE(table1), VContrast, 1, 2, 0, 1, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	...
	gtk_table_attach(GTK_TABLE(table1), VBrightness, 1, 2, 1, 2, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table1), VHue, 1, 2, 2, 3, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table1), VSaturation, 1, 2, 3, 4, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
...
void ShowEquConfig(void)
{
	...
	gtk_entry_set_text(GTK_ENTRY(CEChannel1), gtkEquChannel1);
	gtk_entry_set_editable(GTK_ENTRY(CEChannel1), FALSE);
	gtk_entry_set_text(GTK_ENTRY(CEChannel2), gtkEquChannel2);
	gtk_entry_set_editable(GTK_ENTRY(CEChannel2), FALSE);
	gtk_entry_set_text(GTK_ENTRY(CEChannel3), gtkEquChannel3);
	gtk_entry_set_editable(GTK_ENTRY(CEChannel3), FALSE);
	gtk_entry_set_text(GTK_ENTRY(CEChannel4), gtkEquChannel4);
	gtk_entry_set_editable(GTK_ENTRY(CEChannel4), FALSE);
	gtk_entry_set_text(GTK_ENTRY(CEChannel5), gtkEquChannel5);
	gtk_entry_set_editable(GTK_ENTRY(CEChannel5), FALSE);
	gtk_entry_set_text(GTK_ENTRY(CEChannel6), gtkEquChannel6);
	gtk_entry_set_editable(GTK_ENTRY(CEChannel6), FALSE);
...
static void ecButtonReleased(GtkButton* button, gpointer user_data)
{
	...
	{
		// if you pressed Ok
		nfree(gtkEquChannel1);
		gtkEquChannel1 = gstrdup(gtk_entry_get_text(GTK_ENTRY(CEChannel1)));
		nfree(gtkEquChannel2);
		gtkEquChannel2 = gstrdup(gtk_entry_get_text(GTK_ENTRY(CEChannel2)));
		nfree(gtkEquChannel3);
		gtkEquChannel3 = gstrdup(gtk_entry_get_text(GTK_ENTRY(CEChannel3)));
		nfree(gtkEquChannel4);
		gtkEquChannel4 = gstrdup(gtk_entry_get_text(GTK_ENTRY(CEChannel4)));
		nfree(gtkEquChannel5);
		gtkEquChannel5 = gstrdup(gtk_entry_get_text(GTK_ENTRY(CEChannel5)));
		nfree(gtkEquChannel6);
		gtkEquChannel6 = gstrdup(gtk_entry_get_text(GTK_ENTRY(CEChannel6)));
		eqSetChannelNames();
	}
	HideEquConfig();
}
...
GtkWidget* create_EquConfig(void)
{
	...
	gtk_table_attach(GTK_TABLE(table1), CBChannel1, 1, 2, 0, 1, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table1), CBChannel2, 1, 2, 1, 2, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table1), CBChannel3, 1, 2, 2, 3, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table1), CBChannel4, 1, 2, 3, 4, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table1), CBChannel5, 1, 2, 4, 5, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table1), CBChannel6, 1, 2, 5, 6, (GtkAttachOptions)(GTK_EXPAND | GTK_FILL),
	                 (GtkAttachOptions)(0), 0, 0);
