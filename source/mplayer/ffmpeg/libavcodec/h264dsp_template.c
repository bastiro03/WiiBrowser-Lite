...
void FUNCC(h264_loop_filter_luma)(uint8_t* p_pix, int xstride, int ystride, int inner_iters, int alpha, int beta,
                                  int8_t* tc0)
{
	pixel* pix = p_pix;
	int i, d;
...
void FUNCC(h264_loop_filter_luma_intra)(uint8_t* p_pix, int xstride, int ystride, int inner_iters, int alpha, int beta)
{
	pixel* pix = p_pix;
	int d;
	xstride >>= sizeof(pixel) - 1;
...
void FUNCC(h264_loop_filter_chroma)(uint8_t* p_pix, int xstride, int ystride, int inner_iters, int alpha, int beta,
                                    int8_t* tc0)
{
	pixel* pix = p_pix;
	int i, d;
...
void FUNCC(h264_loop_filter_chroma_intra)(uint8_t* p_pix, int xstride, int ystride, int inner_iters, int alpha,
                                          int beta)
{
	pixel* pix = p_pix;
	int d;
