...
static const AVOption options[] = {
	{
		...
		offsetof(MpegTSWrite, transport_stream_id), AV_OPT_TYPE_INT, {.dbl = 0x0001}, 0x0001, 0xffff,
		AV_OPT_FLAG_ENCODING_PARAM
	},
	{
		"mpegts_original_network_id", "Set original_network_id field.",
		offsetof(MpegTSWrite, original_network_id), AV_OPT_TYPE_INT, {.dbl = 0x0001}, 0x0001, 0xffff,
		AV_OPT_FLAG_ENCODING_PARAM
	},
	{
	...
	},
	{
		...
		offsetof(MpegTSWrite, pmt_start_pid), AV_OPT_TYPE_INT, {.dbl = 0x1000}, 0x0010, 0x1f00,
		AV_OPT_FLAG_ENCODING_PARAM
	},
	{
	...
	{"muxrate", NULL, offsetof(MpegTSWrite, mux_rate), AV_OPT_TYPE_INT, {1}, 0, INT_MAX, AV_OPT_FLAG_ENCODING_PARAM},
	{
		...
		offsetof(MpegTSWrite, pes_payload_size), AV_OPT_TYPE_INT, {DEFAULT_PES_PAYLOAD_SIZE}, 0, INT_MAX,
		AV_OPT_FLAG_ENCODING_PARAM
	},
	{
...
{
	MpegTSWriteStream* ts_st = opaque;
