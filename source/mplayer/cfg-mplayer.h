...
const m_option_t vd_conf[] = {
	{
		...
		CONF_NOCFG | CONF_GLOBAL, 0, 0, NULL
	},
...
const m_option_t mplayer_opts[] = {
	...
	{
		"fsmode",
		"-fsmode is obsolete, avoid it and use -fstype instead.\nIf you really want it, try -fsmode-dontuse, but don't report bugs!\n",
	...
	{
		"use-stdin", "-use-stdin has been renamed to -noconsolecontrols, use that instead.", CONF_TYPE_PRINT, 0, 0, 0,
		NULL
	},
