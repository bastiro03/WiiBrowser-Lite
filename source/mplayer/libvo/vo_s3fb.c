...
static void setup_screen(uint32_t full)
{
	...
	inpageoffset = yuv_on(in_s3_format, in_width, in_height, vidx, vidy, vidwidth, vidheight, 0, screenwidth,
	                      screenheight, screenstride, 0);
...
static void flip_page(void)
{
	...
	{
		vo_draw_text(in_width, in_height, draw_alpha);
		yuv_on(in_s3_format, in_width, in_height, vidx, vidy, vidwidth, vidheight, 0, screenwidth, screenheight,
		       screenstride, page);
		page ^= offset;
		inpage = inpage0 + page;
	}
