...
void init_gain_table(COOKContext* q)
{
	int i;
...
int init_cook_vlc_tables(COOKContext* q)
{
	int i, result;
...
int init_cook_mlt(COOKContext* q)
{
	int j, ret;
...
void init_cplscales_table(COOKContext* q)
{
	int i;
	for (i = 0; i < 5; i++)
...
int cook_decode_close(AVCodecContext* avctx)
{
	int i;
...
int cook_decode_init(AVCodecContext* avctx)
{
	COOKContext* q = avctx->priv_data;
