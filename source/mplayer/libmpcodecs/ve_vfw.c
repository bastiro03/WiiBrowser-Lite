...
static BITMAPINFOHEADER* vfw_open_encoder(char* dll_name, char* compdatafile, BITMAPINFOHEADER* input_bih,
...
static int vfw_start_encoder(BITMAPINFOHEADER* input_bih, BITMAPINFOHEADER* output_bih)
{
	...
	mp_msg(MSGT_WIN32, MSGL_INFO, "  biCompression 0x%lx ('%.4s')\n", output_bih->biCompression,
	       (char*)&output_bih->biCompression);
