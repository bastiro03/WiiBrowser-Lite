...
void* vobsub_open(const char* subname, const char* ifo, int force, void** spu);
void vobsub_reset(void* vob);
int vobsub_parse_ifo(void* this, const char* name, unsigned int* palette, unsigned int* width, unsigned int* height,
                     int force, int sid, char* langid);
...
void* vobsub_out_open(const char* basename, const unsigned int* palette, unsigned int orig_width,
                      unsigned int orig_height, const char* id, unsigned int index);
