...
static int get_packet_header(AVFormatContext* s)
{
	...
	//we only support tightly packed 16-, 20-, 24- and 32-bit PCM at the moment
		...
		{
		case 16: st->codec->codec_id = CODEC_ID_PCM_S16LE;
			break;
		case 20: st->codec->codec_id = CODEC_ID_PCM_LXF;
			break;
		case 24: st->codec->codec_id = CODEC_ID_PCM_S24LE;
			break;
		case 32: st->codec->codec_id = CODEC_ID_PCM_S32LE;
			break;
		default:
