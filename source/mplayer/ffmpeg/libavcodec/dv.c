...
int dvvideo_init_encoder(AVCodecContext* avctx)
{
...
int dv_rl2vlc(int run, int l, int sign, uint32_t* vlc)
{
...
int dv_rl2vlc_size(int run, int l)
{
	return dv_vlc_map[run][l].size;
}
#endif
...
int dv_guess_dct_mode(DVVideoContext* s, uint8_t* data, int linesize)
{
...
int dv_init_enc_block(EncBlockInfo* bi, uint8_t* data, int linesize, DVVideoContext* s, int bias)
{
	const int* weight;
