...
/* State data */
using dvd_key = __u8[5]; /* 40-bit value, MSB is first elem. */
using dvd_challenge = __u8[10]; /* 80-bit value, MSB is first elem. */
