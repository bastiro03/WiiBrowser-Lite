...
static const AVOption options[] = {
	...
	{
		"fast_bilinear", "fast bilinear", 0, AV_OPT_TYPE_CONST, {.dbl = SWS_FAST_BILINEAR}, INT_MIN, INT_MAX, VE,
		"sws_flags"
	},
	...
	{
		"bicublin", "luma bicubic, chroma bilinear", 0, AV_OPT_TYPE_CONST, {.dbl = SWS_BICUBLIN}, INT_MIN, INT_MAX, VE,
		"sws_flags"
	},
	...
	{
		"accurate_rnd", "accurate rounding", 0, AV_OPT_TYPE_CONST, {.dbl = SWS_ACCURATE_RND}, INT_MIN, INT_MAX, VE,
		"sws_flags"
	},
	{
		"full_chroma_int", "full chroma interpolation", 0, AV_OPT_TYPE_CONST, {.dbl = SWS_FULL_CHR_H_INT}, INT_MIN,
		INT_MAX, VE, "sws_flags"
	},
	{
		"full_chroma_inp", "full chroma input", 0, AV_OPT_TYPE_CONST, {.dbl = SWS_FULL_CHR_H_INP}, INT_MIN, INT_MAX, VE,
		"sws_flags"
	},
	...
	{
		"param0", "scaler param 0", OFFSET(param[0]), AV_OPT_TYPE_DOUBLE, {.dbl = SWS_PARAM_DEFAULT}, INT_MIN, INT_MAX,
		VE
	},
	{
		"param1", "scaler param 1", OFFSET(param[1]), AV_OPT_TYPE_DOUBLE, {.dbl = SWS_PARAM_DEFAULT}, INT_MIN, INT_MAX,
		VE
	},
