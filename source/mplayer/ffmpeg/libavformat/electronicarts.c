...
static int process_audio_header_elements(AVFormatContext* s)
{
	...
	{
	case 0: ea->audio_codec = CODEC_ID_PCM_S16LE;
		break;
	case 7: ea->audio_codec = CODEC_ID_ADPCM_EA;
		break;
	case -1:
		switch (revision)
		{
		case 1: ea->audio_codec = CODEC_ID_ADPCM_EA_R1;
			break;
		case 2: ea->audio_codec = CODEC_ID_ADPCM_EA_R2;
			break;
		case 3: ea->audio_codec = CODEC_ID_ADPCM_EA_R3;
			break;
		case -1: break;
		default:
		...
		switch (revision2)
		{
		case 8: ea->audio_codec = CODEC_ID_PCM_S16LE_PLANAR;
			break;
		case 10: ea->audio_codec = CODEC_ID_ADPCM_EA_R2;
			break;
		case 16: ea->audio_codec = CODEC_ID_MP3;
			break;
		case -1: break;
		default:
...
static int process_audio_header_eacs(AVFormatContext* s)
{
	...
	case 0:
		switch (ea->bytes)
		{
		case 1: ea->audio_codec = CODEC_ID_PCM_S8;
			break;
		case 2: ea->audio_codec = CODEC_ID_PCM_S16LE;
			break;
		}
		break;
	case 1: ea->audio_codec = CODEC_ID_PCM_MULAW;
		ea->bytes = 1;
		break;
	case 2: ea->audio_codec = CODEC_ID_ADPCM_IMA_EA_EACS;
		break;
	default:
...
static int ea_read_header(AVFormatContext* s)
{
	...
	if (ea->video_codec)
	{
		...
		st->r_frame_rate = st->avg_frame_rate = (AVRational){
			ea->time_base.den,
			ea->time_base.num
		};
	}
		...
		case SDEN_TAG:
			{
				...
				if (ea->audio_codec == CODEC_ID_PCM_S16LE_PLANAR ||
