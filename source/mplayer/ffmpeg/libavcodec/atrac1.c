...
typedef struct
{
	...
	,
	spec
	)[AT1_SU_SAMPLES]; ///< the mdct spectrum buffer
...
int atrac1_decode_end(AVCodecContext* avctx)
{
	AT1Ctx* q = avctx->priv_data;
...
int atrac1_decode_init(AVCodecContext* avctx)
{
	AT1Ctx* q = avctx->priv_data;
	int ret;
