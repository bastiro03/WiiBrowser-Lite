...
unsigned int vp56_rac_renorm(VP56RangeCoder* c)
{
...
int vp56_rac_get_prob_branchy(VP56RangeCoder* c, int prob)
{
...
int vp56_rac_get(VP56RangeCoder* c)
{
	unsigned int code_word = vp56_rac_renorm(c);
	/* equiprobable */
	int low = (c->high + 1) >> 1;
...
int vp8_rac_get(VP56RangeCoder* c)
{
...
int vp56_rac_gets(VP56RangeCoder* c, int bits)
{
	int value = 0;
...
int vp8_rac_get_uint(VP56RangeCoder* c, int bits)
{
	int value = 0;
...
int vp8_rac_get_sint(VP56RangeCoder* c, int bits)
{
	int v;
...
int vp56_rac_gets_nn(VP56RangeCoder* c, int bits)
{
...
int vp8_rac_get_nn(VP56RangeCoder* c)
{
...
int vp8_rac_get_coeff(VP56RangeCoder* c, const uint8_t* prob)
{
	int v = 0;
