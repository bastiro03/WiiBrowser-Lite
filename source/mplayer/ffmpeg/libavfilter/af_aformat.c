...
static const AVOption options[] = {
	...
	{
		"sample_rates", "A comma-separated list of sample rates.", OFFSET(sample_rates_str), AV_OPT_TYPE_STRING,
		.flags = A
	},
	{
		"channel_layouts", "A comma-separated list of channel layouts.", OFFSET(channel_layouts_str),
...
static int query_formats(AVFilterContext* ctx)
{
	...
	avfilter_set_common_formats(ctx, s->formats ? s->formats : avfilter_all_formats(AVMEDIA_TYPE_AUDIO));
	ff_set_common_samplerates(ctx, s->sample_rates ? s->sample_rates : ff_all_samplerates());
	ff_set_common_channel_layouts(ctx, s->channel_layouts ? s->channel_layouts : ff_all_channel_layouts());
