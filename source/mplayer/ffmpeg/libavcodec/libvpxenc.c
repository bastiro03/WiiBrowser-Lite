...
void log_encoder_error(AVCodecContext* avctx, const char* desc)
{
...
void dump_enc_cfg(AVCodecContext* avctx,
...
void free_coded_frame(struct FrameListData* cx_frame)
{
...
void free_frame_list(struct FrameListData* list)
{
	struct FrameListData* p = list;
...
int codecctl_int(AVCodecContext* avctx,
...
int vp8_free(AVCodecContext* avctx)
{
	VP8Context* ctx = avctx->priv_data;
...
int vp8_init(AVCodecContext* avctx)
{
	VP8Context* ctx = avctx->priv_data;
...
static const AVOption options[] = {
	...
	{
		"arnr-maxframes", "altref noise reduction max frame count", OFFSET(arnr_max_frames), AV_OPT_TYPE_INT, {-1}, -1,
		INT_MAX, VE
	},
	{
		"arnr-strength", "altref noise reduction filter strength", OFFSET(arnr_strength), AV_OPT_TYPE_INT, {-1}, -1,
		INT_MAX, VE
	},
	{
		"arnr-type", "altref noise reduction filter type", OFFSET(arnr_type), AV_OPT_TYPE_INT, {-1}, -1, INT_MAX, VE,
		"arnr_type"
	},
	...
	{
		"deadline", "Time to spend encoding, in microseconds.", OFFSET(deadline), AV_OPT_TYPE_INT,
	...
	{
		"error-resilient", "Error resilience configuration", OFFSET(error_resilient), AV_OPT_TYPE_FLAGS, {0}, INT_MIN,
		INT_MAX, VE, "er"
	},
	...
	{
		"quality", "", offsetof(VP8Context, deadline), AV_OPT_TYPE_INT, {.dbl = VPX_DL_GOOD_QUALITY}, INT_MIN, INT_MAX,
		VE, "quality"
	},
	{"vp8flags", "", offsetof(VP8Context, flags), FF_OPT_TYPE_FLAGS, {.dbl = 0}, 0, UINT_MAX, VE, "flags"},
	{
		"error_resilient", "enable error resilience", 0, FF_OPT_TYPE_CONST, {.dbl = VP8F_ERROR_RESILIENT}, INT_MIN,
		INT_MAX, VE, "flags"
	},
	{
		"altref", "enable use of alternate reference frames (VP8/2-pass only)", 0, FF_OPT_TYPE_CONST,
		{.dbl = VP8F_AUTO_ALT_REF}, INT_MIN, INT_MAX, VE, "flags"
	},
	{
		"arnr_max_frames", "altref noise reduction max frame count", offsetof(VP8Context, arnr_max_frames),
		AV_OPT_TYPE_INT, {.dbl = 0}, 0, 15, VE
	},
	{
		"arnr_strength", "altref noise reduction filter strength", offsetof(VP8Context, arnr_strength), AV_OPT_TYPE_INT,
		{.dbl = 3}, 0, 6, VE
	},
	{
		"arnr_type", "altref noise reduction filter type", offsetof(VP8Context, arnr_type), AV_OPT_TYPE_INT, {.dbl = 3},
		1, 3, VE
	},
	{
		"rc_lookahead", "Number of frames to look ahead for alternate reference frame selection",
		offsetof(VP8Context, lag_in_frames), AV_OPT_TYPE_INT, {.dbl = 25}, 0, 25, VE
	},
	{
		"crf", "Select the quality for constant quality mode", offsetof(VP8Context, crf), AV_OPT_TYPE_INT, {.dbl = 0},
		0, 63, VE
	},
	{NULL}
};
