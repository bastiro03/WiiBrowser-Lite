...
int libgsm_encode_close(AVCodecContext* avctx)
{
...
int libgsm_encode_init(AVCodecContext* avctx)
{
	if (avctx->channels > 1)
	{
...
int libgsm_decode_init(AVCodecContext* avctx)
{
...
int libgsm_decode_close(AVCodecContext* avctx)
{
	LibGSMDecodeContext* s = avctx->priv_data;
