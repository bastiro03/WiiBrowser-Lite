...
void lift(DWTELEM* dst, DWTELEM* src, DWTELEM* ref,
...
void inv_lift(IDWTELEM* dst, IDWTELEM* src, IDWTELEM* ref,
              int dst_step, int src_step, int ref_step,
              int width, int mul, int add, int shift,
              int highpass, int inverse)
{
...
void liftS(DWTELEM* dst, DWTELEM* src, DWTELEM* ref,
           int dst_step, int src_step, int ref_step,
           int width, int mul, int add, int shift,
           int highpass, int inverse)
{
...
void inv_liftS(IDWTELEM* dst, IDWTELEM* src,
