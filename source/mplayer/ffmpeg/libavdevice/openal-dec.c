...
static inline al_format_info* get_al_format_info(ALCenum al_fmt)
{
	static al_format_info info_table[] = {
		...
		[AL_FORMAT_STEREO16 - LOWEST_AL_FORMAT] = {
			AL_FORMAT_STEREO16, AV_NE(CODEC_ID_PCM_S16BE, CODEC_ID_PCM_S16LE), 2
		},
	};
...
static const AVOption options[] = {
	{
		"channels", "set number of channels", OFFSET(channels), AV_OPT_TYPE_INT, {.dbl = 2}, 1, 2,
		AV_OPT_FLAG_DECODING_PARAM
	},
	{
		"sample_rate", "set sample rate", OFFSET(sample_rate), AV_OPT_TYPE_INT, {.dbl = 44100}, 1, 192000,
		AV_OPT_FLAG_DECODING_PARAM
	},
	{
		"sample_size", "set sample size", OFFSET(sample_size), AV_OPT_TYPE_INT, {.dbl = 16}, 8, 16,
		AV_OPT_FLAG_DECODING_PARAM
	},
	{
		"list_devices", "list available devices", OFFSET(list_devices), AV_OPT_TYPE_INT, {.dbl = 0}, 0, 1,
