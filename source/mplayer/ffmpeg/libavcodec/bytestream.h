...
void bytestream2_init(GetByteContext* g,
                      const uint8_t* buf,
                      int buf_size)
{
	g->buffer = buf;
...
unsigned int bytestream2_get_bytes_left(GetByteContext* g)
{
...
unsigned int bytestream2_get_bytes_left_p(PutByteContext* p)
{
...
unsigned int bytestream2_get_bufferu(GetByteContext* g,
                                     uint8_t* dst,
                                     unsigned int size)
{
...
unsigned int bytestream2_put_bufferu(PutByteContext* p,
                                     const uint8_t* src,
                                     unsigned int size)
{
...
unsigned int bytestream_get_buffer(const uint8_t** b,
                                   uint8_t* dst,
                                   unsigned int size)
{
	memcpy(dst, *b, size);
