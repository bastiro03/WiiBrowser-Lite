...
static const AVOption options[] = {
	{
		"top", "top field first", offsetof(RawVideoContext, tff), AV_OPT_TYPE_INT, {.dbl = -1}, -1, 1,
...
int raw_init_decoder(AVCodecContext* avctx)
{
...
int raw_close_decoder(AVCodecContext* avctx)
{
	RawVideoContext* context = avctx->priv_data;
