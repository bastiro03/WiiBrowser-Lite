...
DECLARE_ALIGNED(8, static uint8_t, dither_2x2_4)[2][8] =
 {
{  1,   3,   1,   3,   1,   3,   1,   3, },
{  2,   0,   2,   0,   2,   0,   2,   0, },
};

DECLARE_ALIGNED(8, static uint8_t, dither_2x2_8)[2][8] =
 {
{  6,   2,   6,   2,   6,   2,   6,   2, },
{  0,   4,   0,   4,   0,   4,   0,   4, },
};

DECLARE_ALIGNED(8, uint8_t, dither_4x4_16)[4][8] =
 {
{  8,   4,  11,   7,   8,   4,  11,   7, },
{  2,  14,   1,  13,   2,  14,   1,  13, },
{ 10,   6,   9,   5,  10,   6,   9,   5, },
...
DECLARE_ALIGNED(8, uint8_t, dither_8x8_32)[8][8] =
 {
...
DECLARE_ALIGNED(8, uint8_t, dither_8x8_73)[8][8] =
 {
...
#if 1
DECLARE_ALIGNED(8, uint8_t, dither_8x8_220)[8][8] =
 {
