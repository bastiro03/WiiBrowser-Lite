...
using UpdateCallback = void(*)(void* e);
...
public:
	...
	//!\param font filesize
	bool SetFont(const u8* fontbuffer, u32 filesize);
	//!use spaces?
	...
	//!\param hor Horizontal alignment (ALIGN_LEFT, ALIGN_RIGHT, ALIGN_CENTRE)
	//!\param vert Vertical alignment (ALIGN_TOP, ALIGN_BOTTOM, ALIGN_MIDDLE)
	void SetAlignment(int hor, int vert) override;
...
using OptionList = struct _optionlist
{
	int length;
