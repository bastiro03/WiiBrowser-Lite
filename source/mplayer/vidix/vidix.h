...
{
	TYPE_OUTPUT = 0x00000000,
	/* Is a video playback device */
	TYPE_CAPTURE = 0x00000001,
	/* Is a capture device */
	TYPE_CODEC = 0x00000002,
	/* Device supports hw (de)coding */
	TYPE_FX = 0x00000004,
	/* Is a video effects device */
} vidix_dev_type_t;
...
typedef enum vidix_dev_flag
{
	...
	FLAG_UPSCALER = 0x00000010,
	/* Card supports hw upscaling */
	FLAG_DOWNSCALER = 0x00000020,
	/* Card supports hw downscaling */
	FLAG_SUBPIC = 0x00001000,
	/* Card supports DVD subpictures */
	FLAG_EQUALIZER = 0x00002000,
	/* Card supports equalizer */
} vidix_dev_flag_t;
...
{
	VEQ_FLG_ITU_R_BT_601 = 0x00000000,
	/* ITU-R BT.601 colour space (default) */
	VEQ_FLG_ITU_R_BT_709 = 0x00000001,
