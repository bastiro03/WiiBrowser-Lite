...
static const AVOption movie_options[] = {
	...
	{
		"seek_point", "set seekpoint (seconds)", OFFSET(seek_point_d), AV_OPT_TYPE_DOUBLE, {.dbl = 0}, 0,
		(INT64_MAX - 1) / 1000000
	},
	{
		"sp", "set seekpoint (seconds)", OFFSET(seek_point_d), AV_OPT_TYPE_DOUBLE, {.dbl = 0}, 0,
		(INT64_MAX - 1) / 1000000
	},
...
int movie_common_init(AVFilterContext* ctx, const char* args, void* opaque,
...
void movie_common_uninit(AVFilterContext* ctx)
{
	MovieContext* movie = ctx->priv;
