...
static av_always_inline uint16_t AV_RL16 (const void* p)
{
	...
	__asm__("ld.ub    %0,   %1  \n\t"
	        "ldins.b  %0:l, %2  \n\t"
		: "=&r"(v)
		: "m"(*static_cast<const uint8_t*>(p)), "RKs12"(*(static_cast<const uint8_t*>(p) + 1)));
	return v;
}
...
static av_always_inline uint16_t AV_RB16 (const void* p)
{
	...
	__asm__("ld.ub    %0,   %2  \n\t"
	        "ldins.b  %0:l, %1  \n\t"
		: "=&r"(v)
		: "RKs12"(*static_cast<const uint8_t*>(p)), "m"(*(static_cast<const uint8_t*>(p) + 1)));
	return v;
}
...
static av_always_inline uint32_t AV_RB24 (const void* p)
{
	...
	__asm__("ld.ub    %0,   %3  \n\t"
	        ...
	        "ldins.b  %0:u, %1  \n\t"
		: "=&r"(v)
		: "RKs12"(*static_cast<const uint8_t*>(p)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 1)),
	        "m"(*(static_cast<const uint8_t*>(p) + 2)));
	return v;
}
...
static av_always_inline uint32_t AV_RL24 (const void* p)
{
	...
	__asm__("ld.ub    %0,   %1  \n\t"
	        ...
	        "ldins.b  %0:u, %3  \n\t"
		: "=&r"(v)
		: "m"(*static_cast<const uint8_t*>(p)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 1)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 2)));
	return v;
}
...
static av_always_inline uint32_t AV_RB32 (const void* p)
{
	...
	__asm__("ld.ub    %0,   %4  \n\t"
		...
		: "RKs12"(*static_cast<const uint8_t*>(p)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 1)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 2)),
	        "m"(*(static_cast<const uint8_t*>(p) + 3)));
	return v;
}
...
static av_always_inline uint32_t AV_RL32 (const void* p)
{
	...
	__asm__("ld.ub    %0,   %1  \n\t"
		...
		: "m"(*static_cast<const uint8_t*>(p)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 1)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 2)),
	        "RKs12"(*(static_cast<const uint8_t*>(p) + 3)));
	return v;
}
...
static av_always_inline uint64_t AV_RB64 (const void* p)
{
	...
	v.hl[0] = AV_RB32(p);
	v.hl[1] = AV_RB32(static_cast<const uint32_t*>(p) + 1);
	return v.v;
}
...
static av_always_inline uint64_t AV_RL64 (const void* p)
{
	...
	v.hl[1] = AV_RL32(p);
	v.hl[0] = AV_RL32(static_cast<const uint32_t*>(p) + 1);
	return v.v;
}
