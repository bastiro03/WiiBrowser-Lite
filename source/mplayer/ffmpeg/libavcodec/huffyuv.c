...
static inline void sub_left_prediction_bgr32(HYuvContext* s, uint8_t* dst, const uint8_t* src, int w, int* red,
...
static inline void sub_left_prediction_rgb24(HYuvContext* s, uint8_t* dst, const uint8_t* src, int w, int* red,
                                             int* green, int* blue)
{
	int i;
	int r, g, b;
...
void decode_bgr_1(HYuvContext* s, int count, int decorrelate, int alpha)
{
	int i;
	for (i = 0; i < count; i++)
	{
