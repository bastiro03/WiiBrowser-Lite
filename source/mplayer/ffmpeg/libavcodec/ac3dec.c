...
int ac3_decode_init(AVCodecContext* avctx)
{
...
int ac3_decode_end(AVCodecContext* avctx)
{
	AC3DecodeContext* s = avctx->priv_data;
...
static const AVOption options[] = {
	{
		"drc_scale", "percentage of dynamic range compression to apply", OFFSET(drc_scale), AV_OPT_TYPE_FLOAT, {1.0},
		0.0, 1.0, PAR
	},

	{
		"dmix_mode", "Preferred Stereo Downmix Mode", OFFSET(preferred_stereo_downmix), AV_OPT_TYPE_INT, {.dbl = -1},
		-1, 2, 0, "dmix_mode"
	},
	{
