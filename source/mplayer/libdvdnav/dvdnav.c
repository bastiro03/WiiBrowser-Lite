                                            ...
                                            int32_t* event, int32_t* len)
{
	...
	{
		dvdnav_highlight_event_t* hevent = *buf;
		...
		(this->position_current.domain != this->position_next.domain))
	{
		...
		int32_t vtsN;
		dvdnav_vts_change_event_t* vts_event = *buf;
	...
	{
		dvdnav_cell_change_event_t* cell_event = *buf;
	...
	{
		dvdnav_spu_stream_change_event_t* stream_change = *buf;
	...
	{
		dvdnav_audio_stream_change_event_t* stream_change = *buf;
