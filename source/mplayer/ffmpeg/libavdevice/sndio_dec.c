...
int audio_read_close(AVFormatContext* s1)
{
	SndioData* s = s1->priv_data;
...
static const AVOption options[] = {
	{
		"sample_rate", "", offsetof(SndioData, sample_rate), AV_OPT_TYPE_INT, {.dbl = 48000}, 1, INT_MAX,
		AV_OPT_FLAG_DECODING_PARAM
	},
	{
		"channels", "", offsetof(SndioData, channels), AV_OPT_TYPE_INT, {.dbl = 2}, 1, INT_MAX,
		AV_OPT_FLAG_DECODING_PARAM
	},
	{NULL},
};
