	...
	case WM_CREATE:
		{
			...
			updown1 = CreateUpDownControl(WS_CHILD | WS_VISIBLE |
			                              ...
			                              ((LPCREATESTRUCT)lParam)->hInstance,
			                              edit1, 0, 0, 0);
			SendDlgItemMessage(hwnd, ID_UPDOWN1, UDM_SETRANGE32, 32, 0x7fffffff);
			...
			updown2 = CreateUpDownControl(WS_CHILD | WS_VISIBLE |
			                              ...
			                              ((LPCREATESTRUCT)lParam)->hInstance,
			                              edit2, 0, 0, 0);
			SendDlgItemMessage(hwnd, ID_UPDOWN2, UDM_SETRANGE32, 0, 10000);
			...
			SendDlgItemMessage(hwnd, ID_VO_DRIVER, CB_ADDSTRING, 0, "directx:noaccel");
			...
			SendDlgItemMessage(hwnd, ID_TRACKBAR1, TBM_SETPOS, 1, stereopos);

			if (audio_delay)
				SendDlgItemMessage(hwnd, ID_TRACKBAR2, TBM_SETPOS, 1, delaypos);
			...
			if (proc_priority)
				...
				SendDlgItemMessage(hwnd, ID_PRIO, CB_SETCURSEL, 2, 0);
			...
			case ID_EXTRASTEREO:
				{
					...
					else
					{
						...
						SendDlgItemMessage(hwnd, ID_TRACKBAR2, TBM_SETPOS, 1, 0);
					}
					break;
				}
			case ID_CACHE:
				{
					...
					else
					{
						...
						SendDlgItemMessage(hwnd, ID_UPDOWN1, UDM_SETPOS32, 1, 2048);
					}
					break;
				}
			case ID_AUTOSYNC:
				{
					...
					else
					{
						...
						SendDlgItemMessage(hwnd, ID_UPDOWN2, UDM_SETPOS32, 1, 0);
					}
					break;
				}
			case ID_DEFAULTS:
				{
					set_defaults();
					SendDlgItemMessage(hwnd, ID_VO_DRIVER, CB_SETCURSEL,
					                   SendMessage(vo_driver, CB_FINDSTRING, -1, "directx"), 0);

					SendDlgItemMessage(hwnd, ID_AO_DRIVER, CB_SETCURSEL,
					                   SendMessage(ao_driver, CB_FINDSTRING, -1, "dsound"), 0);
					...
					SendMessage(hwnd, WM_COMMAND, ID_APPLY, 0);
					break;
				}
			case ID_CANCEL:
				DestroyWindow(hwnd);
			...
			case ID_APPLY:
				{
					...
					SendMessage(prio, CB_GETLBTEXT, SendMessage(prio, CB_GETCURSEL, 0, 0), procprio);
