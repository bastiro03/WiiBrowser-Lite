...
static const char* parse_int(const char* const str, int* const valp)
{
	char* endp;
...
static const char* parse_float(const char* const str, float* const valp)
{
	char* endp;
...
static const char* parse_str(const char* str, strarg_t* const valp)
{
 ...
 *
 */
int subopt_parse(const char* const str, const opt_t* opts)
{
	int parse_err = 0, idx;
