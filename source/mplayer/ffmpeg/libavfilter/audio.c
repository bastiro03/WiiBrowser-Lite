                                                             ...
                                                             uint64_t channel_layout)
{
	...
	planes = av_sample_fmt_is_planar(sample_fmt) ? av_get_channel_layout_nb_channels(channel_layout) : 1;
...
void ff_filter_samples(AVFilterLink* link, AVFilterBufferRef* samplesref)
{
		...
		dst->rej_perms & samplesref->perms)
	{
		...
		int planes = !planar ? 1 : av_get_channel_layout_nb_channels(samplesref->audio->channel_layout);
